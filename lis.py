...
# =======================================================
# ВЫЗОВ ИНИЦИАЛИЗАЦИИ БД - ПЕРЕМЕЩЕН СЮДА!
# Это гарантирует, что init_db() выполнится при старте приложения,
# независимо от того, как его запускает WSGI-сервер (например, Gunicorn).
# =======================================================
with app.app_context():
    init_db() # Вызов init_db() здесь
...
if __name__ == "__main__":
    ...
    # init_db() # Эту строку теперь удаляем, так как вызов перенесен выше
